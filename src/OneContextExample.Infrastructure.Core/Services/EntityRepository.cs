...
public abstract class EntityRepository<TEntity>(IDomainEventDispatcher dispatcher)
...
public class EntityRepository<TEntity, TData>(DataContext context, IDomainEventDispatcher dispatcher)
