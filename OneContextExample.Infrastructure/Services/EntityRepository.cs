...
public abstract class EntityRepository<TEntity>(IDomainEventsDispatcher dispatcher)
...
public class EntityRepository<TEntity, TData>(DataContext context, IDomainEventsDispatcher dispatcher)
